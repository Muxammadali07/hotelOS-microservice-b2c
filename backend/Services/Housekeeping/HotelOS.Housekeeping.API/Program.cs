...
builder.Host.UseSerilog((ctx, cfg) =>
{
    ...
    if (!ctx.HostingEnvironment.IsProduction())
        cfg.WriteTo.File("logs/housekeeping-.log", rollingInterval: RollingInterval.Day);
});
...
builder.Services.AddScoped<ICleanlinessLogRepository, CleanlinessLogRepository>();
